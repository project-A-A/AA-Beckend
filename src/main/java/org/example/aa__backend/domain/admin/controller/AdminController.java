...
public class AdminController {
    ...
    public ResponseEntity<?> updateUserRole(@PathVariable Long userId, @RequestBody org.example.aa__backend.domain.admin.payload.RoleDTO dto) {
    ...
    public ResponseEntity<?> updateUserInfo(@PathVariable Long userId, @RequestBody String email) {
